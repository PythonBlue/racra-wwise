...
for folder in sorted(os.listdir(bankPath + os.path.sep + "wwnames" + os.path.sep)):
    if folder.endswith(".txt"):
        ...
        if os.path.exists("wwiser.pyz") and os.path.exists("wwnames.db3"):
            os.system('python3 wwiser.pyz -g -go "' + bankPath + os.path.sep + 'txtp' + os.path.sep + folder.split(".")[0] + '" -gw "..' + os.path.sep + '..' + os.path.sep + 'wem" -gbo -nl "' + bankPath + os.path.sep + 'wwnames' + os.path.sep + folder + '" -l "' + bankPath + os.path.sep + folder.split(".")[0] + '.bnk" "' + bankPath + os.path.sep + 'init.bnk"')
        else:
